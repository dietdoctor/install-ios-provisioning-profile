...
import ioutils = require("./actions-common");
      ...
      fs.writeFile(base64ProfileFile, encodedProfileData, async (err) => {
        if (err) {
          ...
          if (
            ...
            core.error(
              "Input Provisioning Profile Not Found at " +
                provisioningProfileFile
            );
